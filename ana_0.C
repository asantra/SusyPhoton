...
void ana_10(TString outputName="analysis_SUSYSignal_10"){
  ...
  // chain of inputs
  chain.Add("/eos/uscms/store/user/lpcpjm/SusyNtuples/cms538v1/SMS-T5gg_2J_mGl-800to950_mLSP-25to925_TuneZ2star_8TeV-madgraph-tauola_Summer12-START53_V19_FSIM_PU_S12/susyEvents_T5gg_800_125_110.root");
